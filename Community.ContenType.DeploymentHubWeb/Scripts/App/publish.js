...
$(function () {
    ...
    $(".publishContentTypeBtn").on("click", PublishContentTypes);
    $(".ConfirmPublishContentTypeBtn").on("click", ConfirmPublishContentTypes);
    $(".CancelButton").on("click", CancelButton_Clicked);
});

var PublishContentTypes = function(event) {
...
var ConfirmPublishContentTypes = function (event) {
    //post the form to server
    $("#subscriptionForm").submit();
};
