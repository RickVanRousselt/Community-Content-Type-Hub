...
{
    /// <summary>
    /// This provider can be used to create a user clientcontext for the appweb. The provider can only be used in webapplications
    /// </summary>
    public class UserClientContextForSPAppWebProvider : IClientContextProvider
    {
        private ICreateSharePointContextErrorProvider _createClientContextErrorProvider;

        public UserClientContextForSPAppWebProvider()
        {
            _createClientContextErrorProvider = new CreateSharePointContextErrorProvider();
        }

        public UserClientContextForSPAppWebProvider(ICreateSharePointContextErrorProvider createClientContextErrorProvider)
        {
        ...
        public ClientContext CreateClientContext()
        {
            ...
            return spContext.CreateUserClientContextForSPAppWeb();
        }
    }
}
