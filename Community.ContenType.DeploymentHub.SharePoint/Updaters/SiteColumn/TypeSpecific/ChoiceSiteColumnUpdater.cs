...
{
    internal class ChoiceSiteColumnUpdater : TypeSpecificSiteColumnUpdater<FieldChoice>
    {
        private static readonly ILog Logger = LogManager.GetLogger(typeof(ChoiceSiteColumnUpdater));

        public ChoiceSiteColumnUpdater(FieldChoice siteColumn, PublishedSiteColumn publishedSiteColumn) 
